...
- [x] **Step 1: Add parser failures for unapproved compatibility formats**
...
- [x] **Step 2: Run the parser test to verify the new cases fail**
...
- [x] **Step 3: Route XML candidates through `pushCall()`**
...
- [x] **Step 4: Route Python candidates through `pushCall()`**
...
- [x] **Step 5: Run the parser test to verify it passes**
...
- [x] **Step 6: Commit parser hardening**
...
- [x] **Step 1: Make the response mock record HTTP status and add invalid-payload tests**
...
- [x] **Step 2: Run the gateway test to verify the new cases fail**
...
- [x] **Step 3: Add a pure request validator in the gateway**
...
- [x] **Step 4: Run the gateway test to verify it passes**
...
- [x] **Step 5: Commit request validation**
...
- [x] **Step 1: Extend the RPC mock to emit scripted deltas before `stream-end`**
...
- [x] **Step 2: Add an SSE regression for split tool syntax and normal Markdown**
...
- [x] **Step 3: Run the gateway test to verify the split-tool assertion fails**
...
- [x] **Step 4: Add a pure incomplete-prefix predicate**
...
- [x] **Step 5: Preserve the buffer while the prefix remains incomplete**
...
- [x] **Step 6: Run the gateway test to verify it passes**
...
- [x] **Step 7: Commit streaming hardening**
...
- [x] **Step 1: Run syntax checks for modified runtime files**
...
- [x] **Step 2: Run the complete offline regression suite**
...
- [x] **Step 3: Review the final change set**
...
- [x] **Step 4: Commit the implementation plan record if it is not already committed**
